...
# def get_parent(path: str, root) -> Module:
#     parent = root
...
# #         for module in modules:
# #             parent = self.get_ast_parent(module)
# #             attr_name = module.rsplit(".", 1)[-1]
# #             parent.add_attr(
# #                 attr_name=attr_name,
# #                 attr=Module(
...
#         #     setattr(self, func, lambda: 0)# generate_func(self, func))
#
#     return __init__
#
#
...
# #
# #         # attr_name = new_type_fqn.rsplit(".", 1)[-1]
# #         new_type = Any
# #         new_type.__qualname__ = "syft.lib.misc.union.Any"
# #         ast = union_cache.misc_ast
# #         add_classes(ast, [("syft.lib.misc.union.Any", "syft.lib.misc.union.Any", Any)])
# #
# #         methods = [("syft.lib.misc.union.Any.__abs__",
